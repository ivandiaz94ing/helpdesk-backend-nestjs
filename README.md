...
## Sobre el Desarrollo
Este desarrollo backend forma parte de un proyecto de grado aplicado (Universidad Popular del Cesar). Se aplican buenas prácticas de ingeniería de software para asegurar una fácil integración con aplicaciones cliente y futuros despliegues nativos en la nube (Cloud Run / Docker).